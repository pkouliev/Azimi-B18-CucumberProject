package com.cybertek.ClassNotes;
...
===================
What are Locators? Locator is a command by which we can locate GUI elements through selenium

Locators are used to locate Web based webelements.
